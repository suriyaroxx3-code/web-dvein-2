...
const features = [
  ...
  { name: 'Affordable Solutions', desc: 'Top-tier tech solutions and education at accessible price points.', icon: FaHandHoldingUsd, color: 'text-blue-600', bg: 'bg-blue-50' },
];
